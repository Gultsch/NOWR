        ...
        $(document).ready(function () {
            $("#submit").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    data: data,
                    url: '/ajax/AjaxUsers.ashx?action=quicklogin&version=2&flag=' + Math.random(),
                    success: function (msg) {
                        if (msg.Completed) {
                            self.location.href = '/Users/Index.aspx'
                        } else {
                            alert(msg.Msg);
                        }
                    },
...
<div class="clear mt10"></div>
    ...
    <div class="main public_1col">
        ...
        <div class="grid">
            <div class="pt15 pb15">
                <div class="login_pic grid_46">
                    <img src="/img/login_pic.jpg" title="" alt="" class=""  />
                </div>
                <div class="login grid_33 pl50 floatR adorn">
                    <h1 class="grid_27 mt30 color_1">
                        欢迎登录</h1>
                    <div class="grid_27 mt25 bor_bot_1 pb15 mb15">
                        <form id="users">
                        <ul>
                            <li class="mb15 grid">
                                <input class="input grid_25 pl10 pr10" placeholder="请输入您的登录账户" name="userAccount" /></li>
                            <li class="mb15 grid">
                                <input type="password" class="grid_25 input pl10 pr10" placeholder="请输入您的登录密码" name="userPassword" /></li>
                            <li class="mb20 grid">
                                <div class="code floatL border_1">
                                    <img src="/ajax/ajaxValidateCode.ashx" title="" alt="" class=""  /></div>
                                <input class="grid_12 floatL ml10 input  pl10 pr10" placeholder="请输入左边验证码" maxlength="4" name="validateCode" /></li>
                            <li class="mb15 grid">
                                <a href="/public/passwordresetapply.aspx" title="忘记密码？" target="_self" class="pl10 color_1">忘记密码？</a></li>
                            <li class="grid"><a href="javascript:void(0)" class="button_1_b grid_26" id="submit">登 录</a></li>
                        </ul>
                    </div>
                    </form>
                    <div class="grid_27 pb10">
                        <ul>
                            <li class="mb15 grid">
                                <a href="/public/register.aspx" title="注 册" target="_self" class="button_2_b grid_26">注 册</a></li>
                            <li class="mb30 grid assist">如您还未有账户，可以点击“<a href="/public/register.aspx" title="注册" target="_self" class="color_1">注册</a>”成为我们会员</li>
                        </ul>
                    </div>
                </div>
                <div class="clear">
