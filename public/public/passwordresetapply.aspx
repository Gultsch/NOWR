        ...
        $(document).ready(function () {
            $("#submit").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    data: data,
                    url: '/ajax/ajaxusers.ashx?action=resetpasswordapply&version=2&flag=' + Math.random(),
                    success: function (msg) {
                        if (msg.Completed) {
                            self.location.href = './PasswordResetApplyResult.aspx'
                        } else {
                            alert(msg.Msg);
                        }
                    },
   ...
   <div class="main public_1col">
            ...
            <div class="register grid">
                ...
                <div class="bor_bot_1 assist pt10 pb05">
                    请填写以下信息以提交您的重置您的帐户密码申请</div>
                <ul class="mt50 grid_50 ml50">
                    <li class="grid mb15"><span class="grid_09 textR strong pt10">您的登录邮箱：</span><input class="input grid_23 assist pl10 pr10 easyui-validatebox" value="" placeholder="请输入您的登录邮箱" name="UserAccount" required="true" validtype="email" /></li>
                    <li class="grid mb15"><span class="grid_09 textR strong pt10">验证码：</span>
                        <div class="code floatL border_1">
                            <img src="/ajax/ajaxValidateCode.ashx" title="" alt="" class=""  />
                        </div>
                        <input class="assist grid_07 floatL input ml10  pl10 pr10 easyui-validatebox" value="" placeholder="请输入验证码" required="true" name="validateCode" id="invalid_validateText" /></li>
                    <li class="grid mb35"><span class="grid_09 textR strong pt10"></span><a class="button_1_b grid_12" href="javascript:void(0)" id="submit">下一步</a></li>
                </ul>
            </div>
            <div class="clear">
            </div>
